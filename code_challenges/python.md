...
Итак, само задание: доработать функционал автодополнения для библиотеки DjangoQL таким образом, чтобы он поддерживал работу с большими наборами данных. Обуждение и предложенный путь решения здесь (на английском): 
