      ...
      <JobPage job={Jobs.python}>
        <JobTextBlock title="О проектах">
          <p>
            ...
            подходы во всех командах похожи. Сейчас у нас открыты позиции для
        ...
        <JobTextBlock title="О вас">
          <p>
            Мы ожидаем, что у вас несколько лет опыта в веб-разработке и вы
          ...
          <p>
            ...
            обсуждения. Поэтому, кроме технических скиллов, мы ожидаем, что
          ...
          <p>
            ...
            нашими партнерами из США. В связи с этим русский знать
            обязательно; английский &mdash; достаточно уровня Intermediate
