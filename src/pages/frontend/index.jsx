      ...
      <JobPage job={Jobs.frontend}>
        <JobTextBlock title="О проекте">
          <p>
            ...
            подходы во всех командах похожи. Сейчас у нас открыты две
            позиции для Frontend / full-stack разработчиков в проект платформы
        ...
        <JobTextBlock title="Технологии и процессы">
          ...
          />
          <p>
            Все наши проекты используют React и GraphQL, на беке может быть
